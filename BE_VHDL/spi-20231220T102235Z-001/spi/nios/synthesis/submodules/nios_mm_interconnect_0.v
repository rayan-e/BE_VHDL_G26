...
module nios_mm_interconnect_0 (
	...
	wire  [17:0] data_in_s1_agent_m0_address;                                                        // data_in_s1_agent:m0_address -> data_in_s1_translator:uav_address
	...
	wire  [94:0] data_in_s1_agent_rf_source_data;                                                    // data_in_s1_agent:rf_source_data -> data_in_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] data_in_s1_agent_rsp_fifo_out_data;                                                 // data_in_s1_agent_rsp_fifo:out_data -> data_in_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> data_in_s1_agent:cp_valid
	wire  [93:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> data_in_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // data_in_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> data_in_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> data_in_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> data_in_s1_agent:cp_endofpacket
	...
	wire  [17:0] data_out_s1_agent_m0_address;                                                       // data_out_s1_agent:m0_address -> data_out_s1_translator:uav_address
	...
	wire  [94:0] data_out_s1_agent_rf_source_data;                                                   // data_out_s1_agent:rf_source_data -> data_out_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] data_out_s1_agent_rsp_fifo_out_data;                                                // data_out_s1_agent_rsp_fifo:out_data -> data_out_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> data_out_s1_agent:cp_valid
	wire  [93:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> data_out_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // data_out_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> data_out_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> data_out_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> data_out_s1_agent:cp_endofpacket
	...
	wire         data_in_s1_agent_rp_valid;                                                          // data_in_s1_agent:rp_valid -> router_006:sink_valid
	wire  [93:0] data_in_s1_agent_rp_data;                                                           // data_in_s1_agent:rp_data -> router_006:sink_data
	wire         data_in_s1_agent_rp_ready;                                                          // router_006:sink_ready -> data_in_s1_agent:rp_ready
	wire         data_in_s1_agent_rp_startofpacket;                                                  // data_in_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         data_in_s1_agent_rp_endofpacket;                                                    // data_in_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         data_out_s1_agent_rp_valid;                                                         // data_out_s1_agent:rp_valid -> router_007:sink_valid
	wire  [93:0] data_out_s1_agent_rp_data;                                                          // data_out_s1_agent:rp_data -> router_007:sink_data
	wire         data_out_s1_agent_rp_ready;                                                         // router_007:sink_ready -> data_out_s1_agent:rp_ready
	wire         data_out_s1_agent_rp_startofpacket;                                                 // data_out_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         data_out_s1_agent_rp_endofpacket;                                                   // data_out_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         data_in_s1_agent_rdata_fifo_src_valid;                                              // data_in_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] data_in_s1_agent_rdata_fifo_src_data;                                               // data_in_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         data_in_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_004:in_0_ready -> data_in_s1_agent:rdata_fifo_src_ready
	...
	wire         data_out_s1_agent_rdata_fifo_src_valid;                                             // data_out_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] data_out_s1_agent_rdata_fifo_src_data;                                              // data_out_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         data_out_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_005:in_0_ready -> data_out_s1_agent:rdata_fifo_src_ready
	...
	nios_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (data_out_s1_agent_rdata_fifo_src_data),          //     in_0.data
		.in_0_valid     (data_out_s1_agent_rdata_fifo_src_valid),         //         .valid
		.in_0_ready     (data_out_s1_agent_rdata_fifo_src_ready),         //         .ready
